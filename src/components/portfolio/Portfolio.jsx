...
const items = [
  {
    ...
    title: "Transloga",
    img: "/transloga.jpg",
    desc: `Fully responsive web app for a logistics company where user with authentification can instantly add, update or delete current prices.`,
    desc2: `Developed functions: User authentification, Responsiveness, Integration with a backend`,
  ...
  },
  {
    ...
    desc2: `Developed functions: Responsiveness, Integration with a backend, Intuitive Content Management System for editors`,
